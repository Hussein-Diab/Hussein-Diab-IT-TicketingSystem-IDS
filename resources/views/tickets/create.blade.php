        ...
        <div class="form-card">
            ...
            <form method="POST" action="/tickets" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="Description" class="form-control" rows="3" placeholder="Describe the issue in detail..." required>{{ old('Description') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label">
                        ...
                        <span style="color:#aaa;font-size:11px;font-weight:400">
                            (Optional — PNG, JPG, PDF, DOC, max 5MB each)
                        </span>
                    </label>
                    <div class="upload-box" onclick="document.getElementById('fileInput').click()">
                        <i class="bi bi-upload" style="font-size:24px;color:#6C63FF"></i>
                        <div class="upload-text">Click to upload or drag and drop</div>
                        <div class="upload-sub">PNG, JPG, PDF, DOC up to 5MB</div>
                        <div id="fileNames" style="margin-top:8px;font-size:12px;color:#6C63FF"></div>
                    </div>
                    <input type="file" id="fileInput" name="attachments[]" multiple
                        accept=".png,.jpg,.jpeg,.pdf,.doc,.docx" style="display:none" onchange="showFileNames(this)">
                </div>
